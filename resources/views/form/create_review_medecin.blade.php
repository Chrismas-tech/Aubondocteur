...
@section('content')
    ...
    <div class="bg_photo_1 py-5">
        ...
        <div class="mt-5 mb-5 container">
            ...
            <form action="{{ route('review_medecin_store') }}" method="POST" class="text-center">
                @csrf

                <div class="card">

                    <div class="card-header text-center ">
                    <h1 class="display-5 lora">Vos impressions sur le Docteur {{$medecin_just_created->medecin_first_name}} {{$medecin_just_created->medecin_last_name}} </h1>
                    </div>
                    ...
                    <div class="card-body pd-4 bg_gradient_1">
                        ...
                        <div style="width:80%;margin:auto">
                            ...
                            autocomplete="review" autofocus>{{ old('review') }}{{$placeholder_review}}</textarea>
                            </div>
                        ...
                        <div>
                            <input id="user_id" hidden name="user_id" class="form-control" value="{{ $user->id }}">
                        </div>

                        <div>
                            <input id="medecin_id" hidden name="medecin_id" class="form-control" value="{{ $medecin_just_created->id }}">
                        </div>
                        ...
                        <button type="submit" class="btn btn-success btn-lg">
                            Confirmer votre commentaires sur ce médecin
                        </button>
                    </div>
                </div>
