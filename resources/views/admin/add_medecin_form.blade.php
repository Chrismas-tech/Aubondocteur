...
@section('content')
    ...
    <div class="bg_lightgrey py-5">
        <div class="mt-5 mb-5 container">

            <div class="card">

                <div class="card-header text-center ">
                    <h1 class="display-5 lora">Coordonnées du médecin à ajouter</h1>
                </div>

                <div class="card-body pd-4 bg_gradient_1">

                    <div style="width:80%;margin:auto">
                        <form action="{{ route('send_medecin_form') }}" method="POST" class="text-center">
                            @csrf
                            ...
                            <div class="input-group-lg mt-4 mb-4">
                                <select id="speciality" class="form-control @error('speciality') is-invalid @enderror"
                                    name="speciality" value="{{ old('speciality') }}" autofocus>
                            ...
                            <div class="input-group-lg mt-4 mb-4">
                                ...
                                @enderror
                                @error('gps_lat')
                                    <div class="text-white mt-1 text-left">Vous devez sélectionner une adresse suggérée par notre site web</div>
                                @enderror
