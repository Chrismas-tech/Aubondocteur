    ...
    <div class="p-4 bg_photo_3">
        ...
        <div style="width:70%;margin:auto">
            ...
            <div class="mt-3 mb-3 bg-white rounded">
                <h1 class="display-4 lobster p-1 pl-2">Administration du site</h1>
            </div>
                        ...
                        <tbody>
                            @foreach ($users_all as $user_single)
                                <tr>
                                    ...
                                    <td class="p-4 text-center">{{ App\Http\Controllers\DateChangeController::date_created_at_to_string($user_single->created_at) }}</td>
