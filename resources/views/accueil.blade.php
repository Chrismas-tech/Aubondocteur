...
@section('content')
    ...
    <div class="bg_gradient_2 d-flex justify-content-center pt-5 pb-5 pl-3 pr-3 media_button_end_welcome_page">
        <a href="{{ route('compte.index') }}"
            class="btn btn-primary p-3 text-white text-center lora">
            <h2 class="media_button_end_welcome_page">Le médecin que vous avez consulté n'existe pas dans les résultats de recherche ?</h2>
            <h2 class="media_button_end_welcome_page">Créez un compte, renseignez ses coordonnées et laissez-lui une note positive dès maintenant !</h2>
        </a>
    </div>
